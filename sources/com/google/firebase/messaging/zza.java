...
final class zza {
    ...
    private final String zzrz(String str) {
        ...
        try {
            ...
            if (this.zzolv == null) {
                this.zzolv = notificationManager.getClass().getMethod("getNotificationChannel", new Class[]{cls});
            }
            if (!TextUtils.isEmpty(str)) {
            ...
            } else if (this.zzolv.invoke(notificationManager, new Object[]{string}) != null) {
                return string;
            } else {
            ...
            if (this.zzolv.invoke(notificationManager, new Object[]{"fcm_fallback_notification_channel"}) == null) {
                ...
                notificationManager.getClass().getMethod("createNotificationChannel", new Class[]{cls2}).invoke(notificationManager, new Object[]{cls2.getConstructor(new Class[]{cls, CharSequence.class, Integer.TYPE}).newInstance(new Object[]{"fcm_fallback_notification_channel", this.mContext.getString(R.string.fcm_fallback_notification_channel_label), 3})});
            }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:83:0x0248  */
