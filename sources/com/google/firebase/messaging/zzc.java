...
public final class zzc {
    ...
    private static List<Object> zza(AppMeasurement appMeasurement, String str) {
        ...
        try {
            Method declaredMethod = AppMeasurement.class.getDeclaredMethod("getConditionalUserProperties", new Class[]{cls, cls});
    ...
    private static void zza(Context context, String str, String str2, String str3, String str4) {
        ...
        if (zzey(context)) {
            ...
            try {
                Method declaredMethod = AppMeasurement.class.getDeclaredMethod("clearConditionalUserProperty", new Class[]{cls, cls, Bundle.class});
                declaredMethod.setAccessible(true);
                if (Log.isLoggable("FirebaseAbtUtil", 2)) {
                    ...
                    for (Object next : zza(zzde, str3)) {
                        ...
                        if (!zzam.zzpzs.equals(zzbe) || !zzam.zzpzt.equals(zzbf)) {
                            ...
                            while (true) {
                                ...
                                str2 = str4;
                                if (!zzfmuArr[i3].zzpzs.equals(zzbe)) {
                                    i3++;
                                    str4 = str2;
