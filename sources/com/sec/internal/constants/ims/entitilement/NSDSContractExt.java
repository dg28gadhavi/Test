...
public class NSDSContractExt {
    ...
    public static final class Lines implements CommonColumns, LineColumns {
        ...
        public static final Uri buildServicesUri(long j, long j2) {
            Uri withAppendedId = ContentUris.withAppendedId(Devices.CONTENT_URI, j);
            return Uri.withAppendedPath(Uri.withAppendedPath(withAppendedId, "lines/" + j2), GlobalSettingsConstants.Registration.EXTENDED_SERVICES);
        }
