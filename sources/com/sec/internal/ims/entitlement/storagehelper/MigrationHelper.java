...
public class MigrationHelper {
    ...
    public static void reconnectDB(Context context) {
        ...
        createCredentialProtectedStorageContext.getContentResolver().update(Uri.withAppendedPath(NSDSContractExt.AUTHORITY_URI, "reconnect_db"), new ContentValues(), (String) null, (String[]) null);
        createCredentialProtectedStorageContext.getContentResolver().update(Uri.withAppendedPath(EntitlementConfigContract.AUTHORITY_URI, "reconnect_db"), new ContentValues(), (String) null, (String[]) null);
    }
}
