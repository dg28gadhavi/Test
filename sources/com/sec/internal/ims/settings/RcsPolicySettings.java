...
public class RcsPolicySettings {
    ...
    public static final String LOG_TAG = "RcsPolicySettings";
    ...
    public enum RcsPolicyType {
        ...
        private RcsPolicyType(String str) {
            this.mTypeName = str;
        }
        ...
        public static RcsPolicyType fromString(String str) {
            if (str == null) {
                Log.d(RcsPolicySettings.LOG_TAG, "Warning: RcsPolicyType invalid parameter, name is null");
                return DEFAULT_RCS;
            }
            for (RcsPolicyType rcsPolicyType : values()) {
                if (rcsPolicyType.mTypeName.equalsIgnoreCase(str)) {
                    return rcsPolicyType;
                }
            }
            if (str.toUpperCase().contains("_UP")) {
                Log.d(RcsPolicySettings.LOG_TAG, "Warning: RcsPolicyType " + str + " not defined use DEFAULT_UP");
                return DEFAULT_UP;
            }
            Log.d(RcsPolicySettings.LOG_TAG, "Warning: RcsPolicyType " + str + " not defined use DEFAULT_RCS");
            return DEFAULT_RCS;
        }

        public boolean isOneOf(RcsPolicyType... rcsPolicyTypeArr) {
            for (RcsPolicyType rcsPolicyType : rcsPolicyTypeArr) {
                if (this == rcsPolicyType) {
                    return true;
                }
            }
            return false;
    ...
    public boolean load(boolean z) {
        ...
        RcsPolicyType policyType = MnoStrategyCreator.getPolicyType(SimUtil.getSimMno(this.mPhoneId), this.mPhoneId, this.mContext);
        String typeName = policyType.getTypeName();
        String str2 = "";
        if (this.mRcsPolicy.isJsonNull()) {
            str = str2;
        } else {
            str = this.mRcsPolicy.getAsJsonObject().get(ImsAutoUpdate.TAG_POLICY_NAME).getAsString();
        }
        if (!TextUtils.equals(str, typeName) || z) {
            String str3 = LOG_TAG;
            int i = this.mPhoneId;
            IMSLog.i(str3, i, "load from rcspolicy.json " + typeName);
            try {
                openRawResource = this.mContext.getResources().openRawResource(R.raw.rcspolicy);
                ...
                String str4 = ImsAutoUpdate.TAG_DEFAULT_RCS_POLICY;
                ...
                if (jsonElement.isJsonNull() || jsonElement2.isJsonNull()) {
                    IMSLog.i(str3, this.mPhoneId, "load: No default_rcs_policy or default_up_policy. load failed");
                    return false;
                }
                if (RcsPolicyType.fromString(typeName).isUp()) {
                    str4 = ImsAutoUpdate.TAG_DEFAULT_UP_POLICY;
                ...
                if (jsonElement3 == jsonElement5) {
                    ...
                    IMSLog.i(str5, i2, "No policy for " + typeName + " in rcspolicy.json");
                } else if (jsonElement3.getAsJsonObject().has(RCS_AS_POLICY)) {
                    str2 = jsonElement3.getAsJsonObject().get(RCS_AS_POLICY).getAsString();
                    String str6 = LOG_TAG;
                    int i3 = this.mPhoneId;
                    IMSLog.i(str6, i3, "use RCS AS policy " + str2);
                    ...
                    while (true) {
                        ...
                        if (TextUtils.equals(str2, jsonElement6.getAsJsonObject().get(ImsAutoUpdate.TAG_POLICY_NAME).getAsString())) {
                ...
                JsonElement rcsDefaultPolicyUpdate = instance.getRcsDefaultPolicyUpdate(jsonElement, policyType.isUp());
                JsonElement rcsPolicyUpdate = instance.getRcsPolicyUpdate(jsonElement5, str2);
                JsonElement rcsPolicyUpdate2 = instance.getRcsPolicyUpdate(jsonElement3, typeName);
                if (JsonUtil.isValidJsonElement(rcsPolicyUpdate2)) {
                    String str7 = LOG_TAG;
                    int i4 = this.mPhoneId;
                    IMSLog.i(str7, i4, "policy updated: " + typeName);
                ...
                IMSLog.i(str8, i5, "policy not valid " + typeName + " use updated default policy " + str4);
    ...
    public boolean readBool(String str) {
        ...
        if (asJsonObject.has(str)) {
            ...
            String str2 = LOG_TAG;
            Log.d(str2, "readBool:" + str + " : " + asBoolean);
            return asBoolean;
        }
        String str3 = LOG_TAG;
        Log.d(str3, "readBool: " + str + " not exist");
        return false;
    }
    ...
    public int readInt(String str) {
        ...
        if (asJsonObject.has(str)) {
            ...
            String str2 = LOG_TAG;
            Log.d(str2, "readInt:" + str + " : " + asInt);
            return asInt;
        }
        String str3 = LOG_TAG;
        Log.d(str3, "readInt: " + str + " not exist");
        return 0;
    }
    ...
    public String readString(String str) {
        ...
        if (asJsonObject.has(str)) {
            ...
            String str2 = LOG_TAG;
            Log.d(str2, "readString:" + str + " : " + asString);
            return asString;
        }
        String str3 = LOG_TAG;
        Log.d(str3, "readString: " + str + " not exist");
        return "";
    }
    ...
    public List<String> readStringArray(String str) {
        ...
        if (asJsonObject.has(str)) {
            String str2 = LOG_TAG;
            Log.d(str2, "readStringArray: " + str + " exists");
        ...
        String str3 = LOG_TAG;
        Log.d(str3, "readStringArray: " + str + " : " + arrayList);
        return arrayList;
    }
}
