...
public class ATTGlobalVariables {
    ...
    public static boolean ambsDualSimSupport = false;
    ...
    static {
        ...
        String[] split = Build.MODEL.split(CmcConstants.E_NUM_SLOT_SPLIT);
        String str = "SGH_" + split[split.length - 1];
        APPLICATION_ID = str;
        HTTP_CLIENT_ID = str;
        int i = 0;
        while (true) {
    ...
    public static void setAmbsDualSimSupport(boolean z) {
        ambsDualSimSupport = z;
    }

    public static boolean getAmbsDualSimSupport() {
        return ambsDualSimSupport;
    }
