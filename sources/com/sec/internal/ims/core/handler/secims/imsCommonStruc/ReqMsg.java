...
public final class ReqMsg {
    ...
    public static final byte request_alarm_wake_up = 111;
    ...
    public static final byte request_clear_all_call_internal = 117;
    ...
    public static final byte request_emergency_location_publish = 123;
    ...
    public static final byte request_handle_cmc_csfb = 94;
    public static final byte request_handle_dtmf = 98;
    ...
    public static final byte request_ish_accept_session = 96;
    public static final byte request_ish_start_session = 95;
    public static final byte request_ish_stop_session = 97;
    ...
    public static final byte request_ntp_time_offset = 114;
    public static final byte request_open_sip_dialog = 107;
    ...
    public static final byte request_rtp_stats_to_stack = 105;
    public static final byte request_send_cmc_info = 72;
    public static final byte request_send_dm_state = 122;
    public static final byte request_send_dtmf_event = 121;
    ...
    public static final byte request_send_message_revoke_request = 104;
    ...
    public static final byte request_send_sip = 106;
    public static final byte request_send_slm_file = 50;
    public static final byte request_send_text = 99;
    ...
    public static final byte request_set_video_crt_audio = 120;
    public static final byte request_set_vowifi_5gsa_mode = 119;
    public static final byte request_silent_log_enabled = 113;
    public static final byte request_start_camera = 66;
    public static final byte request_start_cmc_record = 118;
    public static final byte request_start_ft_session = 46;
    public static final byte request_start_im_session = 39;
    public static final byte request_start_local_ring_back_tone = 108;
    public static final byte request_start_media = 42;
    public static final byte request_start_record = 115;
    public static final byte request_start_video_earlymedia = 93;
    public static final byte request_stop_camera = 67;
    public static final byte request_stop_local_ring_back_tone = 109;
    public static final byte request_stop_record = 116;
    ...
    public static final byte request_update_geolocation = 92;
    public static final byte request_update_nr_sa_mode_on_start = 124;
    ...
    public static final byte request_update_sim_info = 110;
    public static final byte request_update_srvcc_version = 10;
    public static final byte request_update_time_in_plani = 84;
    public static final byte request_update_vce_config = 103;
    public static final byte request_update_xq_enable = 11;
    public static final byte request_vsh_accept_session = 101;
    public static final byte request_vsh_start_session = 100;
    public static final byte request_vsh_stop_session = 102;
    public static final byte request_x509_cert_verify_result = 112;
    public static final byte request_xdm_fetch_document = 88;
    public static final byte request_xdm_modify_contact = 91;
