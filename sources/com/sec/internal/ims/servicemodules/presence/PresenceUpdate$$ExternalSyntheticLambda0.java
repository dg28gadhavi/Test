...
public final /* synthetic */ class PresenceUpdate$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public /* synthetic */ PresenceUpdate$$ExternalSyntheticLambda0(PresenceUpdate presenceUpdate, int i, PresenceInfo presenceInfo, PresenceSubscription presenceSubscription) {
    ...
    public final void run() {
        this.f$0.lambda$onNewWatcherInformation$1(this.f$1, this.f$2, this.f$3);
    }
}
