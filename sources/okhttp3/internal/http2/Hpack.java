...
public final class Hpack {
    ...
    static {
        ...
        Header header12 = new Header(byteString3, OMAGlobalVariables.HTTP);
        Header header13 = r9;
        Header header14 = new Header(byteString3, OMAGlobalVariables.HTTPS);
        Header header15 = r9;
        ...
        Header header92 = r0;
        Header header93 = new Header(GlsIntent.Extras.EXTRA_LOCATION, str);
        Header header94 = r0;
        ...
        public final void writeHeaders(@NotNull List<Header> list) throws IOException {
            ...
            while (i4 < size) {
                ...
                if (num != null) {
                    i = num.intValue() + 1;
                    if (2 <= i && i < 8) {
                        if (Intrinsics.areEqual(hpack.getSTATIC_HEADER_TABLE()[i - 1].value, byteString)) {
                            i2 = i;
                        } else if (Intrinsics.areEqual(hpack.getSTATIC_HEADER_TABLE()[i].value, byteString)) {
                            int i6 = i;
                            i++;
                            i2 = i6;
                        }
