...
public final class CallServerInterceptor implements Interceptor {
    ...
    public Response intercept(@NotNull Interceptor.Chain chain) throws IOException {
        ...
        if (StringsKt__StringsJVMKt.equals("close", response.request().header("Connection"), true) || StringsKt__StringsJVMKt.equals("close", Response.header$default(response, "Connection", (String) null, 2, (Object) null), true)) {
            exchange$okhttp.noNewExchangesOnConnection();
        }
