...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(@NotNull Interceptor.Chain chain) throws IOException {
        ...
        if (request.header(HttpController.HEADER_HOST) == null) {
            newBuilder.header(HttpController.HEADER_HOST, Util.toHostHeader$default(request.url(), false, 1, (Object) null));
        }
        ...
        if (z && StringsKt__StringsJVMKt.equals("gzip", Response.header$default(proceed, "Content-Encoding", (String) null, 2, (Object) null), true) && HttpHeaders.promisesBody(proceed) && (body = proceed.body()) != null) {
